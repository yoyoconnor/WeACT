      ...
      <div className="flex flex-row w-full h-full" style={{ minHeight: '100vh', maxWidth: '100vw' }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-start bg-[#fdfaf5] min-h-screen p-0">
          <div className="flex flex-col items-center w-full px-10 pt-10 flex-1">
            ...
            <div className="grid grid-cols-3 gap-8 w-full max-w-5xl justify-center">
              {/* Module Cards */}
              {[
                { title: "Module 1.", desc: "Creative Hopelessness", img: "/weekly-modules/thumbnails/module1.png" },
                { title: "Module 2.", desc: "Willingness & Defusion", img: "/weekly-modules/thumbnails/module2.png" },
                { title: "Module 3.", desc: "Acceptance", img: "/weekly-modules/thumbnails/module3.png" },
                { title: "Module 4.", desc: "Observer Self & Present Moment Awareness", img: "/weekly-modules/thumbnails/module4.png" },
                { title: "Module 5.", desc: "Values & Committed Action – Part I", img: "/weekly-modules/thumbnails/module5.png" },
                { title: "Module 6.", desc: "Values & Committed Action – Part II", img: "/weekly-modules/thumbnails/module6.png" },
              ].map((mod, idx) => (
                <div key={idx} className="bg-white shadow p-2 flex flex-col items-center border border-gray-200 rounded-2xl transition-all duration-200 hover:shadow-lg hover:bg-yellow-400" style={{ maxWidth: '250px', minHeight: '230px', paddingBottom: '1.5rem' }}>
            ...
            <div className="text-xs text-gray-500 mb-6 mt-10 self-center w-full text-center" style={{ position: 'absolute', bottom: 0, left: 0, right: 0 }}>
