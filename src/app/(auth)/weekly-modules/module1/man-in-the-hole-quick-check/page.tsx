...
export default function ManInTheHoleQuickCheck() {
  ...
  const getFeedbackTitle = (response: string) => {
    switch (response) {
      case 'YES':
        return "That's a powerful realization!";
      case 'NO':
        return "It's completely normal to feel unsure!";
      case 'NOT SURE':
        ...
        <div className="flex-1 flex flex-col items-center justify-start bg-[#fdfaf5] min-h-screen p-0">
          <div className="flex flex-col items-center w-full px-10 pt-10 flex-1 max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700">
                    I am willing to recognize that trying to control or fix my thoughts and feelings might be like digging deeper with the shovel, and instead, I can stop digging and explore new ways of responding to my thoughts and emotions.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-between w-full max-w-2xl mt-8 mb-8">
              <Link href="/weekly-modules/module1/man-in-the-hole-metaphor" className="px-6 py-3 bg-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-400 transition-colors">
                BACK
              </Link>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-4">
            ...
            <div className="flex justify-between gap-4">
              ...
              <Link 
                href="/weekly-modules/module1/tug-of-war-metaphor"
