...
export default function ManInHoleQuickCheck() {
  ...
  const getFeedbackMessage = (response: string) => {
    switch (response) {
      case 'YES':
        return "That's a powerful realization! Sometimes, trying to control change feels like the only option. Often, it's not. You're learning to notice when you're digging deeper with your thoughts and feelings and engaging your struggle switch in the same system.";
      case 'NO':
        return "That's a brave choice! It's okay if you're not ready to stop digging just yet. Sometimes, trying to control change feels like the only option. Often, it's not. You're learning to notice when you're digging deeper with your thoughts and feelings and engaging your struggle switch in the same system.";
      case 'NOT SURE':
        return "Uncertainty is completely normal! It's okay to feel uncertain about putting down your shovel. You might feel like you're giving up control, but you're actually gaining it. You're learning to notice when you're digging deeper with your thoughts and feelings and engaging your struggle switch in the same system.";
      default:
        return "";
    }
  };
        ...
        <div className="flex-1 flex flex-col items-center justify-start bg-[#fdfaf5] h-full overflow-y-auto p-0">
          <div className="flex flex-col items-center w-full px-10 pt-10 flex-1 max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700">
                    I am willing to stop digging and put down my shovel.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-between w-full max-w-2xl mt-8 mb-8">
              <Link href="/weekly-modules/module1/man-in-hole" className="px-6 py-3 bg-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-400 transition-colors">
                BACK
              </Link>
