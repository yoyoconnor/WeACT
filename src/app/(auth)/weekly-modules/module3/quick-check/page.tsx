...
export default function Module3QuickCheck() {
    ...
    switch (response) {
      case "YES":
        return {
          title: "Great!",
          body:
            "Practicing acceptance with one real scenario can help you build flexibility and reduce struggle. Keep noticing and making space for what shows up while moving toward what matters.",
        };
      case "NOT SURE":
        return {
          title: "It\'s okay",
          body:
            "It\'s normal to feel unsure about trying acceptance. You can start small, at your own pace. As you practice, it often gets easier to make space for difficult experiences.",
        };
      case "NO":
        return {
          title: "That\'s understandable",
          body:
            "Acceptance can be a big shift. If now isn\'t the right time, that\'s okay. We\'ll keep offering gentle steps to help you try this when you feel ready.",
        };
      default:
        return { title: "", body: "" };
    }
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 w-full">
              <div className="flex items-center gap-6 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700">I&apos;m willing to practice acceptance with one real-life scenario this week.</p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-4">
            ...
            <div className="flex justify-between gap-4">
              ...
              <Link href="/weekly-modules/module3/part1-questions" className="flex-1 py-3 bg-yellow-500 text-white rounded-lg font-semibold hover:bg-yellow-600 transition-colors text-center">Continue</Link>
            </div>
          </div>
        </div>
      )}
